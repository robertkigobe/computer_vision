...
# WINDOWS *'VIDX'
writer = cv2.VideoWriter('/Users/robertkigobe/Documents/My_Research/My_Python/Computer_vision/images/rob_student_capture.mp4', cv2.VideoWriter_fourcc(*'XVID'),20, (width, height))
